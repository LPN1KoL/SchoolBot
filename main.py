            ...
            if message.text == 'Расписание':
                ...
                try:
                    ...
                    if system() == 'Windows':
                        ...
                        time.sleep(1)
                        driver.find_element(By.CLASS_NAME, 'Tamh1').screenshot(str(message.chat.id) + ".png")
                        driver.close()
                        driver.quit()
                    elif system() == "Linux":
                        ...
                        display.stop()
                    path = os.getcwd()
                    if os.path.exists(path + '/' + str(message.chat.id) + ".png"):
                        bot.send_photo(message.chat.id, open(path + '/' + str(message.chat.id) + ".png", 'rb'), reply_markup=get_markup(message.chat.id))
                        bot.delete_message(message.chat.id, msg.message_id)
                        os.remove(path + '/' + str(message.chat.id) + ".png")
                    else:
